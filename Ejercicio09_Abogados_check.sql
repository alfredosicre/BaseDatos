drop database if exists 09b_abogados;
create database 09b_abogados;

use 09b_abogados;
set FOREING_KEY_CHECKS = 0; -- para poder hacer tabloas referenciadas sin estar creadas todavia.
