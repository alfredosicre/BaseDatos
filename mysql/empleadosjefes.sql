...
select * from empleados em01 join empleados em02 on em01.fk_jefe = em02.idempleados; -- em01 llamo a la tabla de empleados y em02 llamo a la tabla de jefes, las dos son la misma pero tengo que referenciarlas.
