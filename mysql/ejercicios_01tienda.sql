...
select producto, precio, (precio*0.89) usa from productos;

-- Lista el nombre de los productos, el precio en euros y el precio en dólares estadounidenses (USD). Utiliza los siguientes alias para las columnas: nombre de producto, euros, dólares.
select producto 'nombre de producto', precio euros, (precio*0.89) usa from productos;

-- Lista los nombres y los precios de todos los productos de la tabla producto, convirtiendo los nombres a mayúscula.
select upper(producto), precio from productos;

-- Lista los nombres y los precios de todos los productos de la tabla producto, convirtiendo los nombres a minúscula.
select lower(producto), precio from productos;

-- Lista el nombre de todos los fabricantes en una columna, y en otra columna obtenga en mayúsculas los dos primeros caracteres del nombre del fabricante.
select fabricante, upper(left(fabricante,2)) from fabricantes;

-- Lista los nombres y los precios de todos los productos de la tabla producto, redondeando el valor del precio.
select id_producto, producto, round(precio) from productos; 

-- Lista los nombres y los precios de todos los productos de la tabla producto, truncando el valor del precio para mostrarlo sin ninguna cifra decimal.
select id_producto, producto, truncate(precio,0) from productos;

-- Lista el código de los fabricantes que tienen productos en la tabla producto.
select * from fabricantes join productos on fk_fabricante = id_fabricante;
...
select distinct * from fabricantes join productos on fk_fabricante = id_fabricante;
...
select id_fabricante, producto from productos join fabricantes on id_fabricante = 2;
...
select * from productos where precio >= 60 and precio <= 300;
...
select * from productos where precio > 200 and fk_fabricante = 6;

-- Lista todos los productos donde el código de fabricante sea 1, 3 o 5. Sin utilizar el operador IN.
select * from productos where fk_fabricante = 1 or fk_fabricante = 3 or fk_fabricante = 5;

-- Lista todos los productos donde el código de fabricante sea 1, 3 o 5. Utilizando el operador IN.
select * from productos where fk_fabricante in (1,3,5);

-- Lista el nombre y el precio de los productos en céntimos (Habrá que multiplicar por 100 el valor del precio). Cree un alias para la columna que contiene el precio que se llame céntimos.
select producto, (precio*100) céntimos from productos;

-- Lista los nombres de los fabricantes cuyo nombre empiece por la letra S.
select * from fabricantes where fabricante like 's%';

-- Lista los nombres de los fabricantes cuyo nombre termine por la vocal e.
select * from fabricantes where fabricante like '%e';

-- Lista los nombres de los fabricantes cuyo nombre contenga el carácter w.
select * from fabricantes where fabricante like '%w%';

-- Lista los nombres de los fabricantes cuyo nombre sea de 4 caracteres.
select * from fabricantes where length(fabricante)=4;

-- Devuelve una lista con el nombre de todos los productos que contienen la cadena Portátil en el nombre.
select * from productos where producto like '%Portátil%';
